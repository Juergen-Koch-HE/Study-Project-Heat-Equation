...
Dieser Ordner enthält zwei Unterordner, einen für LaTeX, einen für Word. Im 'tex' Ordner ist eine Angepasste Version des IEEE LaTeX Templates für Konferenzen sowie eine Hilfe zum besseren Schreiben von wissenschaftlichen Texten.

Bitte beachten Sie folgende Dateien:

  abstract.pdf - Eine Erklärung des Aufbaus und der Inhalte des Abstracts

  tex/abstract.tex - ein LaTex Dokument für Sie als Grundlage

  doc/abstract.doc - eine Word-Vorlage für Leute ohne LaTeX Ambitionen. Wenn
                 Sie diese Vorlage verwenden so beachten Sie bitte die
                 Inhalte von abstract.pdf genau

  tex/IEEEtran_HOWTO.pdf - Eine Erklärung zur Verwendung des IEEE Templates

  tex/IEEEtran_HOWTO.cls - Das LaTeX Style Template



Bitte beachten Sie weitere nützliche Dokumente im 'help' Ordner:
  help/bessere-texte-schreiben.pdf - eine Hilfe zum Schfreiben besserer Texte
                                bitte VOR dem Schreiben lesen


------------------ Ursprüngliches IEEE Readme -------------------------
