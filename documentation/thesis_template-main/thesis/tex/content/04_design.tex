...
Da eine homogene DGL immer Y(x) = 0 sein muss, ergibt sich aus der Liniaritöt der Teillösungen auch also y_1=0 und Y_2=0 sein.
\[ 0 = C_1*0+C_2*0\] !!!!ist noch falsch aber checke auc nicht !!!
