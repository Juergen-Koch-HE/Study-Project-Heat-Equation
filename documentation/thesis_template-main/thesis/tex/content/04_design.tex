...
$|e^{i \phi}| = 1$ das bedeuted das der Betrag der komplexen Zahlen, die die Form $e^{i \phi}$ haben, immer den Abstand 1 zum Nullpunkt des Koordinatensystems. Da sie sich auf dem Einheitskreis bewegen und dieser in jede richtung und in jedem winkel den selben Betrag hat ist. 
