...
Eine Fourier-Reihe stellt eine periodische mathematische Funktionen, in sich wiederholenden Sinus- und Kosinus thermen dar. Das beduted die ergebnisse dieser Gleichungen wiederholen sich nach einer Periode $T$ (Koch & Stempfle, 2018, S.191).  
Damit eine Funnktion als periodisch gilt muss sie $f(x+p)=f(x)$ sein, wobei die Periode $p > 0$ ist (Koch & Stempfle, 2018, S.191).
