...
Zum Abschluss wird noch die Fourier-Sinusreihe als Simulation erstellt. Wie bereits der einfache Sinus wird die Reihe als Wärmebild dargestellt. Für diese Aufgabe wird eine zuvor erstellte Funktion verwendet, um, wie bei der Sinusfunktion ein 2D-Array mit den Temperaturwerten zu füllen. Eine Möglichkeit, das zu tun, ist folgende:
...
Wie bereits erwähnt ähnelt auch die Fourier-Sinusreihe dem des einfachen Sinus, nach kurzer Zeit ($t=120$ ms), wie nachfolgend zu sehen ist.
\begin{figure}[htbp]
  \centering
