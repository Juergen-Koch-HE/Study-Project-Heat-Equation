...
Die Wärmeleitungsgleichung lässt sich direkt aus der Energiebilanz eines infinitesimalen Volumenelement herleiten \cite[S.~15--28]{langemann2018so}.
Dabei wird der Energieerhaltungssatz mit dem Fourierschen Gesetz kombiniert, um die partielle Differenzialgleichung für die Temperaturentwicklung abzuleiten.
...
\[
E = \rho \, c \, u(x,t) \, \Delta x
\]

wobei \rho die Dichte, $c$ die spezifische Wärmekapazität bezeichnet.
...
\subsubsection{Einsetzen des Fourierschen Gesetzes}
...
a^2 = \frac{k}{\rho c}
\]
wird als Temperaturleitkoeffizienten bezeichnet. Die Wärmeleitungsgleichung lautet somit:
\[
u_t(x,t) = a^2 \cdot u_{xx}(x,t)
\]

%So einfach ist Mathematik, Partielle Differenzialgleichungen für Anwender. Springer, Abschnitte 2.1--2.3.
