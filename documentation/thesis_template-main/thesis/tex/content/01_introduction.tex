...
Nachfolgend wird der Aufbau des Labors “Simulation der Wärmeleitungsgleichung in Festkörpern” in einem Jupyter Notebook beschrieben, das den Studierenden im Fach “Modellbildung und Simulation” bereitstehen soll.
...
0 &
Imports &
Einrichten der Arbeitsumgebung durch das Importieren von später benötigten Bibliotheken.  \\
\hline
1 &
Modelling &
...
4.2 &
Fourier sine &
Zusammensetzen der Lösung aus vielen Sinuswellen, sodass nun auch die Anfangsbedingung möglichst gut erfüllt werden kann.  \\
\hline
\end{tabularx}
\caption{Aufbau des Labors}
